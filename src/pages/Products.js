...
function Products({productItem,cartItem,addToCart,removeCart}) {
    ...
    useEffect(() => {
        if(window.location.path = '/san-pham') {
        ...
        <div className="products">
            <div className="container">
                <div className="breadcrumb">
                    ...
                    <div className='title_page'> Tất cả sản phẩm </div>
                </div>
                <div className='content'>
                    <div className='row'>
                        <div className='col sidebar'>
                            ...
                            <aside className='coffee_content_banner'>
                                <img src={AsideBanner} />
                            </aside>
                        </div>
                        <div className='col product'>
                            ...
                            <div className='product_view'>
                                {show===false && productItem.map((product) => {
                                ...
                                {show===true && productItem.map((product) => {
