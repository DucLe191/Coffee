...
function Juice({productItem,cartItem,addToCart,removeCart}) {
    ...
    useEffect(() => {
        if(window.location.path = '/nuoc-ep') {
        ...
        <div className="juice">
            <div className="container">
                <div className="breadcrumb">
                    ...
                    <div className='title_page'> Nước ép </div>
                </div>
                    ...
                    <div className='row'>
                        ...
                        <div className='col product'>
                            ...
                            <div className='product_view'>
                                {productItem.map((product) => {
                                    if(product.type=='nuoc-ep' && show===false) {
                                ...
                                {productItem.map((product) => {
                                    if(product.type=='nuoc-ep' && show===true) {
