...
function Cocktail({productItem,cartItem,addToCart,removeCart}) {
    ...
    useEffect(() => {
        if(window.location.path = '/cock-tail') {
        ...
        <div className="cocktail">
            <div className="container">
                <div className="breadcrumb">
                    ...
                    <div className='title_page'> Cocktail </div>
                </div>
                    ...
                    <div className='row'>
                        ...
                        <div className='col product'>
                            ...
                            <div className='product_view'>
                                {productItem.map((product) => {
                                    if(product.type=='cock-tail' && show===false ) {
                                ...
                                {productItem.map((product) => {
                                    if(product.type=='cock-tail' && show===true) {
