...
function Cake({productItem,cartItem,addToCart,removeCart}) {
        ...
        <div className="cake">
            <div className="container">
                <div className="breadcrumb">
                    ...
                    <div className='title_page'> Cake </div>
                </div>
                    ...
                    <div className='row'>
                        ...
                        <div className='col product'>
                            ...
                            <div className='product_view'>
                                {productItem.map((product) => {
                                    if(product.type=='cake' && show===false) {
                                ...
                                {productItem.map((product) => {
                                    if(product.type=='cake' && show===true) {
